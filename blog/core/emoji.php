<?php
    ...
    class emoji
    {
        ...
        static function classic($text)
        {
            foreach (emoji::$enhanced as $k => $v)
            {
        ...
        static function enhanced($text)
        {
            $jsonfile = dirname(__FILE__) . '/../content/emoji.json';
            ...
            foreach ($json as $obj)
            {
                ...
                $name = $values['name'];
                $desc = (array_key_exists('description', $values)) ? $values['description'] : '';

                if (array_key_exists('altnames', $values))
                {
                    $altnames = $values['altnames'];

                    foreach ($altnames as $altname)
                    {
                        $text = str_replace(':' . $altname . ':', '<i class="em-svg em-' . $name . '" aria-role="presentation" aria-label="' . $desc . '"></i>', $text);
                    }
                }
                else
                {
                    $text = str_replace(':' . $name . ':', '<i class="em-svg em-' . $name . '" aria-role="presentation" aria-label="' . $desc . '"></i>', $text);
                }
            }
            return $text;
        }
